  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        numberRoll:    { '0%': { transform: 'translateY(100%)', opacity: '0' },   '100%': { transform: 'translateY(0)', opacity: '1' } },
        scanline:      { '0%': { top: '-4px' }, '100%': { top: '100%' } },
      },
      animation: {
        fadeIn:        'fadeIn 0.3s ease-out both',
        slideIn:       'slideIn 0.25s ease-out both',
        terminalBlink: 'terminalBlink 1s step-end infinite',
        slideInRight:  'slideInRight 0.25s ease-out both',
        numberRoll:    'numberRoll 0.3s ease-out both',
