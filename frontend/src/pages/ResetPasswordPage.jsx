...
const S = {
  ...
  card: { width: '100%', maxWidth: 400, padding: '40px 36px', background: '#1E293B', borderRadius: 16, border: '1px solid #334155', boxShadow: '0 25px 60px rgba(0,0,0,0.5)' },
...
export default function ResetPasswordPage() {
  ...
  if (!token) return (
    <div style={S.page}><div style={S.card}>
      <h1 style={{ margin: '0 0 12px', fontSize: 18, fontWeight: 700, color: '#F1F5F9' }}>Invalid link</h1>
      <p style={{ fontSize: 13, color: '#94A3B8', marginBottom: 20 }}>This reset link is missing or malformed.</p>
    ...
    <div style={S.page}>
      <div style={S.card}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <p style={{ margin: '6px 0 0', fontSize: 13, color: '#64748B' }}>Choose a strong password for your account.</p>
        </div>
        ...
        {done ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div>
              <label style={S.label}>New password <span style={{ color: '#475569', fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}>(min 8 chars)</span></label>
