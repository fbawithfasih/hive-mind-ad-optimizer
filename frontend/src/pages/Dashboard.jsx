...
import { getProfiles, getCampaigns, getReports, executeCommand } from '../services/api.js';
...
export default function Dashboard() {
  ...
  async function handleLoadMetrics() {
    ...
    setError(null);
    try {
      const data = await getReports(selectedProfileId || undefined, dateFrom, dateTo);
      setCampaigns(Array.isArray(data.campaigns) ? data.campaigns : []);
      setMetricsDateRange({ start: data.startDate, end: data.endDate });
    } catch (err) {
