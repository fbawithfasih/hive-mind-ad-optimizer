  ...
  return (
    <div style={{ borderRadius: 12, overflow: 'hidden', border: '1px solid #8B5CF640', animation: 'fadeIn .3s ease-out both' }}>
      <style>{`
        ...
        .ai-body td           { padding:10px 14px; font-size:13px; color:#E2E8F0; border-bottom:1px solid #1E293B; white-space:nowrap; }
        .ai-body tbody tr:last-child td { border-bottom:none; }
        .ai-body tbody tr:hover td      { background:#263348; }
        .ai-body tbody tr:nth-child(even) td { background:#1a2535; }
        .ai-body tbody tr:nth-child(even):hover td { background:#263348; }
        ...
        .ai-body li           { margin:5px 0; color:#CBD5E1; line-height:1.6; }
        .ai-body strong       { color:#F59E0B; font-weight:700; }
        .ai-body em           { color:#94A3B8; font-style:italic; }
        .ai-body code         { background:#1a2535; color:#38BDF8; padding:2px 7px; border-radius:4px; font-size:11.5px; font-family:monospace; }
        .ai-body h1,.ai-body h2,.ai-body h3 { color:#F1F5F9; margin:16px 0 8px; line-height:1.3; }
        .ai-body h1 { font-size:18px; } .ai-body h2 { font-size:15px; } .ai-body h3 { font-size:13px; }
        .ai-body blockquote   { border-left:3px solid #8B5CF6; margin:0 0 12px; padding:4px 14px; background:#8B5CF610; border-radius:0 6px 6px 0; color:#CBD5E1; }
        .ai-body hr           { border:none; border-top:1px solid #334155; margin:14px 0; }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 13, color: '#F1F5F9' }}>AI Analysis</span>
          <span style={{ fontSize: 11, color: '#64748B' }}>· {result.model === 'claude' ? 'Claude Sonnet' : 'Gemini 2.5 Flash'}</span>
        </div>
        <button onClick={copy} style={{
          ...
          color: copied ? '#10B981' : '#94A3B8', transition: 'all .15s',
        }}>
          {copied
      ...
      {/* ── Body ── */}
      <div className="ai-body" style={{ padding: '16px 18px', background: '#1E293B', fontSize: 13, color: '#E2E8F0', lineHeight: 1.65 }}>
