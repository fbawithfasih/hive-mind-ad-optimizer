...
const S = {
  ...
  header:  { padding: '16px 20px', borderBottom: '1px solid #334155', display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  ...
  btn:     (active) => ({
    ...
    background: active ? 'linear-gradient(135deg,#3B82F6,#8B5CF6)' : '#263348',
    color: active ? '#fff' : '#475569',
  }),
  ghost:   { padding: '5px 12px', borderRadius: 6, border: '1px solid #334155', background: 'transparent', fontSize: 12, fontWeight: 600, color: '#94A3B8', cursor: 'pointer' },
  ...
  row:     { display: 'flex', alignItems: 'center', gap: 14, padding: '14px 20px', borderBottom: '1px solid #1E293B' },
